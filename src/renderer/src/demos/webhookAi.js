export default function webhookAi() {
  return {
    ...
    edges: [
      { id: 'd3_e1', source: 'd3_1', sourceHandle: 'a', target: 'd3_2', targetHandle: 'a', type: 'smoothstep', animated: true },
      { id: 'd3_e2', source: 'd3_2', sourceHandle: 'a', target: 'd3_3', targetHandle: 'a', type: 'smoothstep', animated: true }
    ]
  }
}
